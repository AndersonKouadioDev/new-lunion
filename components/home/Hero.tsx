...
export default function Hero() {
  ...
  const slides = [
    {
      ...
      description:
        "Exploiter avec énergie des impératifs omniprésents sans collaboration ni partage d'idées de pointe. Expériences inter-unités et front-end monotones et parallèles des tâches..",
    ...
    },
    {
      ...
      description:
        "Intégrez en toute transparence des technologies de pointe à des solutions d'infrastructure robustes. Proposez des systèmes évolutifs, sécurisés et efficaces qui s'adaptent aux besoins de votre entreprise.",
    ...
    },
    {
      ...
      description:
        "Transformez votre entreprise grâce à des initiatives numériques stratégiques. Exploitez des données et des méthodologies innovantes pour optimiser votre avantage concurrentiel.",
  ...
  return (
    <div
      className={`h-[100vh-150px] 2xl:max-h-[1200px] bg-gradient-to-br ${currentSlideData.background}  relative overflow-hidden transition-all duration-1000 ease-in-out `}
      style={{
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 right-0 w-80 h-80 opacity-20">
          <div
            className="absolute bottom-0 right-20 w-40 h-40 bg-white/10 transform rotate-45 animate-spin"
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center h-full w-full px-6 lg:px-20">
        ...
        <div className="flex-1 w-full max-w-2xl text-white pt-20 lg:pt-0">
          ...
          <div className="flex items-center mb-8 lg:mb-12 animate-fadeIn">
            ...
            <span className="ml-4 text-base lg:text-lg font-medium tracking-wide">
          ...
          {/* Description */}
          <p
            className="text-base lg:text-xl text-white/80 mb-8 lg:mb-12 max-w-xl leading-relaxed animate-slideInLeft"
          ...
          >
            <button className="group flex items-center justify-center sm:justify-start px-6 py-3 lg:px-8 lg:py-4 text-white/90 border border-white/30 rounded-full hover:bg-white/10 transition-all duration-300">
              <Link href={"/service"} className="mr-2">
                DISCOVER MORE
              </Link>
