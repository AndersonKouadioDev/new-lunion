...
export default function PartnerSection() {
  ...
  return (
    <div className="relative bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 overflow-hidden">
            ...
            >
              ...
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-100 to-purple-100 rounded-xl group-hover:scale-110 transition-transform duration-300">
                  <div className="scale-150">{logo.icon}</div>
                </div>
      ...
      <div
        className="absolute bottom-20 right-20 w-24 h-24 bg-gradient-to-br from-purple-200 to-pink-200 rounded-full opacity-30 blur-lg animate-pulse"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute top-1/3 right-1/4 w-6 h-6 bg-blue-400 rounded transform rotate-45 opacity-40 animate-bounce"
        style={{ animationDelay: "2s" }}
      />
      <div
        className="absolute bottom-1/3 left-1/4 w-4 h-4 bg-purple-400 rounded-full opacity-50 animate-bounce"
