...
export default function PricingPlans() {
  const plans = [
    {
      ...
      period: "/mo",
      description:
        "Il existe de nombreuses variantes disponibles, mais la majorité ont souffert.",
      features: [
  ...
  return (
    <div>
      <div className="w-full bg-gradient-to-r text-center from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white text-xl font-semibold py-4 px-6 rounded-xl  mb-4 shadow-lg">
        Offrez vous un package
      </div>
      <div className="bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 px-8 py-16 w-full">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {plans.map((plan, index) => (
              <div key={index} className="relative">
                ...
                <div
                  className={`${plan.bgColor} ${plan.textColor} rounded-2xl p-8 h-full border border-gray-700 shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-purple-500/20`}
                >
                  {/* Header */}
                  <div className="mb-8">
